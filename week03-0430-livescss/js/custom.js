$(document).ready(function () {
    ...
    $(".js-anc01").on("click", function () {
        let offsetTop = $('#js-page01').offset().top;
        $('html, body').stop().animate({
            scrollTop: offsetTop
        }, 500);
    });
    $(".js-anc02").on("click", function () {
        let offsetTop = $('#js-page02').offset().top;
        $('html, body').stop().animate({
            scrollTop: offsetTop
        }, 500);
    });
    $(".js-anc03").on("click", function () {
        let offsetTop = $('#js-page03').offset().top;
        $('html, body').stop().animate({
            scrollTop: offsetTop
        }, 500);
    });
    $(".js-anc04").on("click", function () {
        let offsetTop = $('#js-page04').offset().top;
        $('html, body').stop().animate({
            scrollTop: offsetTop
        }, 500);
    });
